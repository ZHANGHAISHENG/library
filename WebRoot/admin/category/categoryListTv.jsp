  ...
  <head>
	...
	<script language="javascript">
     ...
     function t(key,parentKey){
          if(key!=0){
          window.parent.frames["detail"].location.href="../book/bookAdd.jsp?cateId="+key;
          }
    ...
    function modify(key,parentKey){
      if(key!=0){
       window.parent.frames["detail"].location.href="categoryModify.jsp?from=ListTv&id="+key+"&pId="+parentkey;
      }
     } 
