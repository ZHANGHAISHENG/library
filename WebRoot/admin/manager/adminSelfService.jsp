...
<html>
  ...
  <body>
    <center><h1>自服务</h1></center>
			<form name="form" action="adminSelfService.jsp" method="post" >
				<input type="hidden" name="action" value="adminModify"></input>
				<table align="center" border="1">
				   <tr>
				      <td>id：</td>
				      <td>
				        <input type="text" name="id" id="id" size="30"  value=<%=admin.getId() %>  disabled></input>
						<span id="idTip"></span>
				      </td>
				   </tr>
				   <tr>
				   ...
				   <tr>
				      ...
				      <td>
				        <select name="sex" id="sex">
				          ...
				          <option value="男"   <%=(admin.getSex().trim().equals("男"))?"selected":"" %> >男</option>
				          <option value="女"   <%=(admin.getSex().trim().equals("女"))?"selected":"" %>>女</option>
				        </select>
						<span id="sexTip"></span>
				      </td>
				   </tr>
