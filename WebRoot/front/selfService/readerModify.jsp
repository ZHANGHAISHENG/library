			...
			<form name="form" action="readerModify.jsp" method="post" onsubmit="return checkData()">
				...
				<table align="center" border="1">
				   <tr>
				      <td>id：</td>
				      <td>
				        <input type="text" name="rId" id="rId" size="30" value=<%=reader.getId() %> disabled></input>
				      </td>
				   </tr>
				   <tr>
				      <td>名字：</td>
				   ...
				   <tr>
				    ...
				    <tr>
				      <td>密码：</td>
				      <td>
				        <input type="passWord" name="rPassword" id="rPassword" value=<%=reader.getrPassword() %> size="30" onblur=""></input>
